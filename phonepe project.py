...
def top_chart_appopens(table_name, state):
    ...
    with col2:
        ...
        if "districts" in df_2.columns and "appopens" in df_2.columns:
            fig_amount_2 = px.bar(
            df_2, 
            x="districts", 
            y="appopens", 
            title="LAST 10 APPOPENS", 
            ...
            st.error("DataFrame does not have the required columns: 'districts' and 'appopens'")
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\dhanushiya\OneDrive\Desktop\image1.jpg"),width= 300)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\dhanushiya\OneDrive\Desktop\image2.jpg"),width=300)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\dhanushiya\OneDrive\Desktop\image3.png"),width= 300)
